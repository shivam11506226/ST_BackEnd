...
mongoose.model("fAQModel", faqSchema).find({}, async (err, result) => {
    if (err) {
        ...
        var obj1 = {
            type: staticContentsType.FLIGHTS,
        ...
        var obj5 = {
            type: staticContentsType.HOTELS,
        ...
        var obj9 = {
            type: staticContentsType.HOLIDAYPACKAGE,
        ...
        var obj17 = {
            type: staticContentsType.TRAINS,
