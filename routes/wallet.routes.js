...
module.exports = function (app) {
  ...
  app.put('/travvolt/wallet/update_amount/:id',SchemaValidator(schemas.addwalletAmountSchema),controller.update_amount);
  app.get('/travvolt/wallet/showWallet/:id',controller.showWallet);
  app.post('/travvolt/wallet/pay_amount/:id',SchemaValidator(schemas.payWalletAmount),controller.pay_amount);
